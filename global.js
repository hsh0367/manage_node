...
const User_Promo_Schema = {
  name: 'USER_PROMO',
  properties: {
    promo_name: { type: 'string', default: '0' }, //등록한 프로모이름
...
const Sim_Imsi_Schema = {
  ...
  // primaryKey: 'imsi',
  properties: {
    imsi:  {type :'string',default: '0'},
    sim_pid: { type: 'int', default: 0 }, //tb_si2m_list  pid
    user_pid: { type: 'int', default: 0 }, //심 사용자 의 tb_user pid
    user_id: { type: 'string', default: '0' }, //심 사용자의 아이디
    user_serial: { type: 'string', default: '0' }, //심 사용자의 시리얼
    lur_date: { type: 'int', default: 0 }, //마지막으로 lur 한 시간
    mcc: { type: 'string', default: '0' }, //심의 mcc 국가 코드
    mnc: { type: 'string', default: '0' }, //심의 mnc 이통사 코드
    lac: { type: 'string', default: '0' }, //tmsi 갱신되었을 때 lac 심인증정보
    cell_id: { type: 'string', default: '0' }, //tmsi 갱신되었을 때 cell id
    bsic: { type: 'string', default: '0' }, //tmsi 갱신되었을 때 bsic
    arfcn: { type: 'int', default: 0 }, //tmsi 갱신되었을 때 arfcn
    tmsi: { type: 'string', default: '0' },
    kc: { type: 'string', default: '0' }, //tmsi 갱신되었을 때 kc
    cksn: { type: 'int', default: 0 }, //tmsi 갱신되었을 때 cksn
    msisdn: { type: 'string', default: '0' }, //심의 전화번호
    sim_id: { type: 'string', default: '0' }, //심뱅크 ID
    sim_serial_no: { type: 'int', default: 0 }, //심뱅크 심 위치
    simbank_name: { type: 'string', default: '0' }, //심뱅크 이름
    connector: { type: 'string', default: '0' }, //마지막으로 사용한 c118
    imei: { type: 'string', default: '0' }, //getData할때  생성한 imei 임의 단말기 고유값
    ...
    sim_expire_date: { type: 'int', default: 0 }, // sim_expire_date : milli sec
...
const RateSchema = {
  ...
  properties: {
    ...
    area_name: { type: 'string', default: '0' }, //국가이름
...
const UserInfoSchema = {
  ...
  properties: {
    ...
    user_id: { type: 'string', default: '0' }, //사용자 아이디
    user_pw: { type: 'string', default: '0' }, // 사용자 비밀번호
    user_serial: { type: 'string', default: '0' }, //사용자 시리얼 회원가입 mysql 겹치지 않게
    ...
    user_sim_imsi: { type: 'string', default: '0' }, //사용자가 쓰는 심 IMIS
    ...
    fcm_push_key: { type: 'string', default: '0' },
    voip_push_key: { type: 'string', default: '0' },
  }
};
...
const MediaSchema = {
  ...
  properties: {
    ...
    ip: { type: 'string', default: '0' }, //voip proxy ip
...
const Connector_Info_Schema = {
  ...
  properties: {
    ...
    connector: { type: 'string', default: '0' }, //모바일 아이디
    boxgroup: { type: 'int', default: 0 },
    mcc: { type: 'string', default: '0' }, //셋팅한 통신사(mobile country codes)
    mnc: { type: 'string', default: '0' }, //셋팅한 통신사(mobile network codes)
